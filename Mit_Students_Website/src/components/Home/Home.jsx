        ...
        <div className="mx-auto w-full max-w-7xl">
            ...
            <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
                <div className="relative z-10 max-w-screen-xl px-4 pb-20 pt-10 sm:py-24 mx-auto sm:px-6 lg:px-8">
                    <div className="max-w-xl sm:mt-1 mt-80 space-y-8 text-center sm:text-right sm:ml-auto">
                        <h3 className="text-4xl font-bold sm:text-5xl">
                            Explore Now </h3>
                        <h2>
                            <span className="hidden sm:block text-4xl">MIT Marketplace</span>
                        </h2>

                        <p className="text-gray-800 ">         Your one-stop solution for exclusive products and deals!</p>
                ...
                <div className="absolute inset-0 w-250 sm:my-20 sm:pt-1 pt-12 h-100">
                    <img className="w-250 object-cover" src="https://img.pikbest.com/origin/06/30/60/89ppIkbEsTD7K.jpg!w700wp" alt="Promotional Banner" />
                </div>
            </aside>
