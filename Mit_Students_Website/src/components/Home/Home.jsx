...
export default function Home() {
 ...
 <aside className="explore relative w-full h-screen">
    <div className="absolute inset-0 z-10 flex flex-col justify-center items-right text-right bg-opacity-500">
        <div className="max-w-screen-xl px-4">
            <h3 className="text-4xl font-bold sm:text-6xl mb-4">Explore Now</h3>
            <h2 className="hidden sm:block text-3xl font-bold mb-4">MIT Marketplace</h2>
            <p className="text-100 font-bold mb-6">
                Your one-stop solution for exclusive <br />products and deals!
            </p>
            <Link
                className="inline-flex items-center px-6 py-3 font-medium bg-white rounded-lg hover:bg-red-500 transition duration-300"
                to="/"
            >
                <svg
                    fill="black"
    ...
    <div className="absolute inset-0">
        <img
            ...
            src="https://cdn.pixabay.com/photo/2018/12/09/11/24/sale-3864703_1280.jpg"
        ...
        />
            ...
            <div className="py-10 text-center bg-gradient-to-r from-blue-200 to-indigo-300">
